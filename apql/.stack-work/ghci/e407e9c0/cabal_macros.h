...
/* package apql-0.0.0 */
#ifndef VERSION_apql
#define VERSION_apql "0.0.0"
#endif /* VERSION_apql */
#ifndef MIN_VERSION_apql
#define MIN_VERSION_apql(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  0 || \
  (major1) == 0 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_apql */
...
/* package tasty-quickcheck-0.10.1.1 */
#ifndef VERSION_tasty_quickcheck
#define VERSION_tasty_quickcheck "0.10.1.1"
...
#define CURRENT_COMPONENT_ID "apql-0.0.0-2sjVV8q4UrdA48ZnHDUR88-primary-test-suite"
